  ...
  return (
    <div className=" w-full max-w-2xl mx-auto bg-gray-800 rounded-xl border border-gray-700 shadow-md p-6 sm:p-8 flex flex-col items-center sm:flex-row sm:items-center sm:gap-8 relative">
      <div className="absolute top-4 right-4 sm:top-6 sm:right-6">
        <select className="w-fit text-sm rounded-md border-gray-600 bg-gray-700 text-gray-200 shadow-sm focus:ring-blue-500 focus:border-blue-500" value={lang} onChange={handleLangChange} aria-label="Seleccionar idioma">
